        ...
        messages: [
          {
            role: "system",
            content:
              "Esti un jurnalist senior de actualitate si editor SEO. Scrii riguros factual, clar, natural, cu compunere variata si utilitate reala pentru cititor. Eviti cliseele, repetitiile si limbajul promotional despre alte publicatii.",
          },
          {
            role: "user",
            content: buildPrompt(
