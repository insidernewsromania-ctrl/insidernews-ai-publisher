...
EDITORIAL_AUTHOR_NAME=Gabriel Andrei
EDITORIAL_AUTHOR_PROFILE_URL=https://insidernews.ro/author/gabriel/
...
# Regula zilnica pentru categoria "Cum sa?" (ID 6064)
HOWTO_DAILY_ENABLED=true
HOWTO_DAILY_CATEGORY_ID=6064
HOWTO_DAILY_TARGET=2
HOWTO_DAILY_POSTS_PER_RUN=1
HOWTO_DAILY_TIMEZONE=Europe/Bucharest
HOWTO_DAILY_SLOTS=10:15,18:15
HOWTO_SLOT_GRACE_MINUTES=20
HOWTO_SLOT_STRICT=true
HOWTO_MIN_WORDS=350
HOWTO_ATTEMPTS=3
HOWTO_TOPIC_HINT=
```
